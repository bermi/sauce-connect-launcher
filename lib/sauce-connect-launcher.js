...
function getArchiveName() {
  ...
  }[process.platform] || process.arch === "ia32" ? "sc-" + sc_version + "-linux32.tar.gz" : "sc-" + sc_version + "-linux.tar.gz";
}
...
function getScFolderName() {
  ...
  }[process.platform] || process.arch === "ia32" ? "sc-" + sc_version + "-linux32" : "sc-" + sc_version + "-linux";
}
